package com.chekh.paysage.feature.main.apps.presentation.adapter.holder
...
class AppGroupHeaderViewHolder(
    private val view: AppGroupHeaderView,
    ...
    fun bind(position: Int, appCategory: AppGroupModel) = with(view) {
