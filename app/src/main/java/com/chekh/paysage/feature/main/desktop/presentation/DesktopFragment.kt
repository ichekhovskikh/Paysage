...
import com.chekh.paysage.feature.main.apps.presentation.AppDockViewModel
...
import com.chekh.paysage.feature.main.options.presentation.DesktopOptionsFragment
...
class DesktopFragment : BaseFragment(R.layout.fragment_desktop), PageLocationProvider {
    ...
    private fun setupListeners() {
        ...
        adapter.setOnItemsCommittedListener { items ->
            ...
            (activity as? HomeActivity)?.setTargetDragViewBounds(bounds?.toRectF())
        }
    }
    ...
    companion object {
        ...
        operator fun invoke(args: Args) = DesktopFragment().applyArgs(args)
    }
}
