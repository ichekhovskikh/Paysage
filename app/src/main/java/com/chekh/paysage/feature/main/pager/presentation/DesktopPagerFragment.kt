...
import com.chekh.paysage.core.ui.contracts.StartActivityForResultLauncher
...
import com.chekh.paysage.feature.main.desktop.presentation.DesktopViewModel
import com.chekh.paysage.feature.main.desktop.presentation.tools.PageLocationProvider
import com.chekh.paysage.feature.main.desktop.presentation.tools.DesktopWidgetHostManager
import com.chekh.paysage.feature.main.desktop.presentation.tools.getWidgetBounds
...
class DesktopPagerFragment :
    ...
    val activityForResultLauncher = StartActivityForResultLauncher(this)
    ...
    private fun setPages(pages: List<DesktopPageModel>) {
        ...
        pages.sortedBy { it.position }
            .map {
                val fragment = adapter.getFragment(it.id) ?: DesktopFragment(DesktopFragment.Args(it.id))
                it.id to fragment
            }
    ...
    private fun requestWidgetAttachPermissions(
        ...
        activityForResultLauncher(attachPermissionsIntent) {
            when (it.resultCode) {
